...
public interface IStorageService {
    ...
    default boolean supports(FileMetadata metdata) { return true; }
    boolean persist(FileMetadata metadata, InputStream file) throws IOException;

    boolean exists(String fileId);
    File retrieve(String fileId) throws IOException;
